...
module.exports = function(config) {
  ...
  config.set({
    ...
    files: [
      ...
      'app/scripts/vendors/bower_components/tinymce/tinymce.min.js',
      ...
      'app/scripts/vendors/bower_components/angular-ui-tinymce/src/tinymce.js',
      'app/scripts/vendors/bower_components/angular-sanitize/angular-sanitize.js',
